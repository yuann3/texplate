...
$endif$
$endif$
  pdfcreator={Mr. Boombastic a.k.a Big B and his neovim}}
...
$for(author)$
$if(author.name)$
$author.name$$if(author.affiliation)$\\ $author.affiliation$ $if(author.email)$\\ \texttt{<\href{mailto:$author.email$}{$author.email$}>}$endif$$endif$
$else$
$author$
$endif$
$endfor$
